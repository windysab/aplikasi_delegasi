...
class M_delegasi extends CI_Model
{
    ...
    ");
		...
		// $this->db->where("dm.tgl_surat >=", '2023-12-01');
		// $this->db->where("dm.tgl_surat <=", '2023-12-31');
		// $this->db->where("dpm.tgl_surat_diterima >=", '2023-12-01');
		// $this->db->where("dpm.tgl_surat_diterima <=", '2023-12-31');
		// $this->db->where("dpm.tgl_penunjukan_jurusita >=", '2023-12-01');
		// $this->db->where("dpm.tgl_penunjukan_jurusita <=", '2023-12-31');
		// $this->db->where("dpm.tgl_relaas >=", '2023-12-01');
		// $this->db->where("dpm.tgl_relaas <=", '2023-12-31');
		// $this->db->where("dpm.tgl_pengiriman_relaas >=", '2023-12-01');
		// $this->db->where("dpm.tgl_pengiriman_relaas <=", '2023-12-31');
